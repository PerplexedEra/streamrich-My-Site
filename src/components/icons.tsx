...
export const Icons = {
  ...
  paypal: (props: LucideProps) => (
    <svg role="img" viewBox="0 0 24 24" {...props}>
      <path fill="currentColor" d="M7.076 21.337H2.47a.641.641 0 0 1-.633-.74L4.944.901C5.026.382 5.474 0 5.998 0h7.46c2.57 0 4.578.543 5.69 1.81 1.01 1.15 1.304 2.42 1.012 4.287-.023.143-.047.288-.077.432-.983 5.05-4.349 6.797-8.647 6.797h-2.19c-.524 0-.968.382-1.05.9l-1.12 7.106zm14.146-14.42a3.35 3.35 0 0 0-.607.541c-.81 1.077-1.5 1.376-3.442 1.376h-.72c-.84 0-1.14.176-1.295.288a.69.69 0 0 0-.263.55l-.72 4.551H10.5l.24-1.29a1.36 1.36 0 0 1 1.344-1.1h.68c3.76 0 6.705-1.528 7.565-5.946.36-1.847.17-3.355-.777-4.471z"/>
    </svg>
  ),
